...
for i in sim_p:
    ax_dict["cA"].plot(t_sim,i['CL'][0]['_x','cA'],label="cA_closed-loop")
    ax_dict["cB"].plot(t_sim,i['CL'][0]['_x','cB'],label="cB_closed-loop")
    ax_dict["teta"].plot(t_sim,i['CL'][0]['_x','teta'],label="teta_closed-loop")
    ax_dict["teta_K"].plot(t_sim,i['CL'][0]['_x','teta_K'],label="teta_K_closed-loop")
...
plt.savefig("nominal_with p_variation.CSTR.pdf", format="pdf")
plt.savefig("nominal_with p_variation.CSTR.svg", format="svg")
...
# ax_dict["cA"].plot(t_sim,cA_NN,color='black')
...
# ax_dict["cB"].plot(t_sim,cB_NN,color='black')
...
# ax_dict["teta"].plot(t_sim,teta_NN,color='black')
...
# ax_dict["teta_K"].plot(t_sim,teta_K_NN,color='black')
