...
cut1 = np.zeros((nx,1)) # cuts in the first and second dimension
cut1[0] = 4
cut1[1] = 4
...
suptitle = fig.suptitle("{0}-step RCIS (full partitioning[ns={1}])".format(N,ns),fontweight = 'bold', fontsize=28, y =1.1)
fig.align_labels()
