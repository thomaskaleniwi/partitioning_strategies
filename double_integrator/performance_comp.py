...
base_dir = "D:/partitioning approaches_double integrator/1_0_0_1"

datadict_CL_run_different_9 = np.load(os.path.join(base_dir,'datadict_CL_run_different_9.npy'),allow_pickle = True).item() #item() converts loaded object to a python scalar object
datadict_CL_run_different_16 = np.load(os.path.join(base_dir,'datadict_CL_run_different_16.npy'),allow_pickle = True).item()
datadict_CL_run_different_24 = np.load(os.path.join(base_dir,'datadict_CL_run_different_24.npy'),allow_pickle = True).item()
datadict_CL_run_different_30 = np.load(os.path.join(base_dir,'datadict_CL_run_different_30.npy'),allow_pickle = True).item()
datadict_CL_run_different_36 = np.load(os.path.join(base_dir,'datadict_CL_run_different_36.npy'),allow_pickle = True).item()
datadict_CL_run_different_45 = np.load(os.path.join(base_dir,'datadict_CL_run_different_45.npy'),allow_pickle = True).item()
datadict_CL_run_different_54 = np.load(os.path.join(base_dir,'datadict_CL_run_different_54.npy'),allow_pickle = True).item()

datadict_CL_run_constant_9 = np.load(os.path.join(base_dir,'datadict_CL_run_constant_9.npy'),allow_pickle = True).item()
datadict_CL_run_constant_16 = np.load(os.path.join(base_dir,'datadict_CL_run_constant_16.npy'),allow_pickle = True).item()
datadict_CL_run_constant_24 = np.load(os.path.join(base_dir,'datadict_CL_run_constant_24.npy'),allow_pickle = True).item()
datadict_CL_run_constant_30 = np.load(os.path.join(base_dir,'datadict_CL_run_constant_30.npy'),allow_pickle = True).item()
datadict_CL_run_constant_36 = np.load(os.path.join(base_dir,'datadict_CL_run_constant_36.npy'),allow_pickle = True).item()
datadict_CL_run_constant_45 = np.load(os.path.join(base_dir,'datadict_CL_run_constant_45.npy'),allow_pickle = True).item()
datadict_CL_run_constant_54 = np.load(os.path.join(base_dir,'datadict_CL_run_constant_54.npy'),allow_pickle = True).item()

datadict_CL_run_full_9 = np.load(os.path.join(base_dir,'datadict_CL_run_full_9.npy'),allow_pickle = True).item()
datadict_CL_run_full_16 = np.load(os.path.join(base_dir,'datadict_CL_run_full_16.npy'),allow_pickle = True).item()
datadict_CL_run_full_24 = np.load(os.path.join(base_dir,'datadict_CL_run_full_24.npy'),allow_pickle = True).item()
datadict_CL_run_full_30 = np.load(os.path.join(base_dir,'datadict_CL_run_full_30.npy'),allow_pickle = True).item()
datadict_CL_run_full_36 = np.load(os.path.join(base_dir,'datadict_CL_run_full_36.npy'),allow_pickle = True).item()
datadict_CL_run_full_45 = np.load(os.path.join(base_dir,'datadict_CL_run_full_45.npy'),allow_pickle = True).item()
datadict_CL_run_full_54 = np.load(os.path.join(base_dir,'datadict_CL_run_full_54.npy'),allow_pickle = True).item()
...
def closed_loop_cost(data):
    ...
    for i in range(N_sim):
        J_cl = J_cl + (data['CL'][0]['_x','x'][i].reshape((2,1))-x_ref.reshape((2,1))).T@Q@(data['CL'][0]['_x','x'][i].reshape((2,1))-x_ref.reshape((2,1))) + (data['CL'][0]['_u','u'][i].reshape((2,1))-u_prev.reshape((2,1))).T@R@(data['CL'][0]['_u','u'][i].reshape((2,1))-u_prev.reshape((2,1)))
...
plt.savefig("Performance_double_10_01.pdf", format="pdf")
plt.savefig("Performance_double_10_01.svg", format="svg")
...
# ax2[1,2].step(datadict_CL_run_different['CL'][0]['_time'],closed_loop_cost(datadict_CL_run_different)[1:],where = 'post')
